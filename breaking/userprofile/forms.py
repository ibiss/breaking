...
class UserCreateForm(UserCreationForm):
	...
	def save(self, commit=True):
		...
		user_profile = UserProfile(user=user, first_name=first_name, second_name = second_name, status=True, latitude = latitude, longitude = longitude, timestamp=datetime.datetime.now())
		user_profile.save()
