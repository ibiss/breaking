...
urlpatterns = patterns('',
	...
	url(r'^challenge/', 'userprofile.views.joinQueue'),
    url(r'^webservices/', include(webservices.urls)),
    url(r'^messagebox/(?P<userid>\d+)$', 'userprofile.views.message_view'),
    url(r'^messagebox/', 'userprofile.views.messagebox_view'),
